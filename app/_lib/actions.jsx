...
export async function createBooking(bookingData, formData) {
  ...
  const newBooking = {
    ...
    numGuests: Number(formData.get("numGuests")) || 1, // Default to 1 if not provided
  ...
  if (error) {
    ...
    throw new Error(`Booking could not be created. Error: ${error.message}`);
  }

  // Optionally, log the data returned from Supabase
